...
<body>
  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <div class="profile">
        <img src="user/assets/img/profile.jpg" alt="" class="img-fluid rounded-circle">
        <h1 class="text-light"><a href="index.php">Perpustakaan</a></h1>
      ...
      <nav id="navbar" class="nav-menu navbar">
        <ul>
          ...
          <li><a href="register.php" class="nav-link scrollto"><i class="bi bi-person-plus"></i><span>Register</span></a></li>
          <li><a href="login.php" class="nav-link scrollto"><i class="bi bi-box-arrow-left"></i><span>Log In</span></a></li>
          </ul>
      </nav><!-- .nav-menu -->
    </div>
  </header><!-- End Header -->
